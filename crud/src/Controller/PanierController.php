...
class PanierController extends AbstractController
{
    ...
    #[Route('/savedList', name: 'app_panier_saved_index', methods: ['GET'])]
    ...
    #[Route('/delete/{id}', name: 'app_panier_delete', methods: ['POST' , 'GET'])]
    public function delete(Request $request, Saved $Saved, SavedRepository $SavedRepository): Response
    {
        ...
        return $this->redirectToRoute('app_panier_saved_index', [], Response::HTTP_SEE_OTHER);
    }
}
