 ...
 */
final class Version20230501143551 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD reset_token VARCHAR(100) NOT NULL, CHANGE image image VARCHAR(65535) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP reset_token, CHANGE image image MEDIUMTEXT NOT NULL');
